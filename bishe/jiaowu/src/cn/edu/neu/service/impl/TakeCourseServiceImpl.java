...
public class TakeCourseServiceImpl implements TakeCourseService {
	...
	/*
	 * Override public int addTakeCourse(TakeCourse takecourse,
	 * List<SuccessTakeCourse> successTakeCourse) {
	 * 
	 * int takecourseId = takecourse.getTakecourseId();
	 * 
	 * for (int j = 0; j < successTakeCourse.size(); j++) { SuccessTakeCourse stc =
	 * successTakeCourse.get(j); stc.setTakeCourseId(takecourseId);
	 * mapper.saveSuccessTakeCourse(stc); } return takecourseId; }
	 */
