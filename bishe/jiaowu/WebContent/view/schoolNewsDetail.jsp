						...
						<div class="container-fluid">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-7">
										<div class="panel panel-info">
										<c:if test="${!empty newsDetail }">
											<div class="panel-heading">
												<h3 class="panel-title"><a href="${pageContext.request.contextPath}/news/getNews">校园资讯</a>></h3>
											</div>
											
												<div class="panel-body">
													<h3 id="nav5">&nbsp;&nbsp;&nbsp;${ newsDetail.newsName }</h3>
												<hr>
												<h3 id="nav6">&nbsp;&nbsp;&nbsp;${ newsDetail.newsText }</h3>
												<img src="${pageContext.request.contextPath}${ newsDetail.newsPic}"
												width=630 height=400 />
												</div>
											
											</c:if>
												<c:if test="${empty newsDetail }">选课相关通知</c:if>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-info">
