...
<script type="text/javascript">
	...
	function login(redirUrl) {
		...
		$.post(getContextPath() + "/user/adminlogin", {
			userName : userName,
			userPass : userPass
		}, function(result) {
			...
			if (result.login == "yes") {
				...
				if (redirUrl)
					...
					location.href = getContextPath() + "/view/manage_all.jsp";
			} else {
				//alert("false");
				$("#msgTitle").html("登录失败");
...
<body>
	...
	<div class="row">
		...
		<div class="panel panel-info">
         ...
         <a href="login_user.jsp" >学 生</a>
             <a href="login_admin.jsp" class="btn btn-info">管理员</a>
				</div>
				</div>
				...
				<div class="form-group">
					...
					onclick="login('${redirUrl}')">管理员登录</button>
