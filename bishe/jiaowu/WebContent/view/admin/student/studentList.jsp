...
<script type="text/javascript">
	...
	function check() {
		if (!validateCheckbox("userIds", "请至少选中一个学生用户"))
			return false;
		else
			return confirm("确实要删除选中的所有学生用户吗？");
	}
	function logout() {
										...
										<div class="col-md-12">
											<div class="panel panel-info">
												<div class="panel-heading">
													<div class="container-fluid">
														<div class="col-md-3">
															<h3 class="panel-title" id="nav7">学生用户信息列表</h3>
														</div>
														<div class="col-md-9">
												...
												<div class="panel-body">
													<c:if test="${!empty user.list }">
														<div class="table-responsive ">
															<form name="userForm" method="post"
																action="${pageContext.request.contextPath}/admin/user/delStudentByIds"
																onsubmit="return check()">
																<button class="btn btn-info" type="submit">批量删除</button>
																&nbsp;&nbsp;<a
																	href="${pageContext.request.contextPath}/admin/user/handleStudent"
																	type="button" class="btn btn-info">添加学生用户</a>
																<table class="table table-striped">
																	<thead>
																		<tr>
																			<th><input type="checkbox" id="selAllUser"
																				onchange="selUserBut('userForm', 'userIds')" /> 全选</th>
																			<th>#</th>
																			<th>学生姓名</th>
																			<th>学生照片</th>
																			<th>学生专业</th>
																	...
																	<tbody>
																		<c:forEach items="${user.list}" var="g" varStatus="vs">
																			<tr>
																				...
																				<td>${g.userName }</td>
																				<td><img
																					src="${pageContext.request.contextPath}${g.userPic}"
																				...
																				<td><a
																					...
																					| <a
																					href="${pageContext.request.contextPath}/admin/user/delStudent?userId=${g.userId}"
																					onclick="return confirm('确定要删除这个学生用户吗？')">删除</a></td>
																			</tr>
																		</c:forEach>
																	</tbody>
																</table>
													...
													<c:if test="${empty user.list }">学生用户信息为空</c:if>
												</div>
											</div>
