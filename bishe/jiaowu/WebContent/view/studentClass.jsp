										...
										<div class="panel panel-info">
											...
											<div class="panel-body">
												<a href="${pageContext.request.contextPath}/view/studentData.jsp" class="btn btn-default" type="button">
												 ...
												 <a href="${pageContext.request.contextPath}/course/getCourseByClass?userId=${sessionScope['_LOGIN_USER_'].userId }" class="btn btn-info" type="button">
									...
									<div class="col-md-7">
										<div class="panel panel-info">
											<div class="panel-heading">
												<div class="modal-title text-center">
													<h3 class="panel-title">学生课表查询查询</h3>
												</div>
											</div>
											<div class="panel-footer">
												<form class="form-inline" role="form" id="searchForm"
													method="post"
													action="${pageContext.request.contextPath}/course/getCourseByClass?userId=${sessionScope['_LOGIN_USER_'].userId }">

													<div class="form-group">
														<label for="cateId"> 学期</label> <select
															class="form-control input-sm" name="courseClass"
															id="courseClass">
															<option value="${c.courseClass }">---所有学期---</option>
															<c:if test="${!empty course.list }">
																<c:forEach items="${course.list }" var="c">

																	<option value="${c.courseClass }" ${param.courseClass==c.courseClass?'selected':''} >${fn:escapeXml(c.courseClass)}</option>
																</c:forEach>
															</c:if>
													...
													<%-- <div class="form-group">
														<label for="courseClass"> 学期</label> <input
															class="form-control input-sm" name="courseClass"
															id="courseClass" value="${fn:escapeXml(param.courseClass)}"
															type="text" placeholder="第几学期" />
													</div> --%>
										...
										<div class="panel panel-info">
											...
											<div class="panel-body">
												...
												<c:if test="${empty course.list }">学校课程为空</c:if>
											</div>
