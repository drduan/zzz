...
<script src="${pageContext.request.contextPath}/js/jquery-3.3.1.js"></script>
 ...
 <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=NfQ7ctQPvrtp1UNHfB25sG60wLO6BSVd"></script>
  </head>
...
<body>
									...
									<div class="col-md-7">
										<div class="panel panel-info">
											...
											<div class="panel-body">
												...
												<div class="form-group">
													<div class="col-sm-12">
														...
														<button id="levSend" class="btn btn-default">留言</button>
														<span id="msg"></span>
													</div>
												</div>
											...
											<div class="panel-footer">
												...
												<!--  百度地图 -->
												 <div style="width:550px;height:275px;border:#ccc solid 1px;font-size:12px" id="map"></div>
     </p>
											</div>
										</div>
									</div>
										...
										<div class="panel panel-info">
											...
											<div class="panel-body">
												<address>
													...
													<a href="mailto:121231223@qq.com">1406877145@qq.com</a>
												</address>
											</div>
											<div class="panel-footer">
												<address>
 ...
 <script type="text/javascript">
    ...
    function addMapOverlay(){
      var markers = [
        {content:"我的备注",title:"我的标记",imageOffset: {width:0,height:3},position:{lat:38.89958,lng:121.540117}}
      ];
