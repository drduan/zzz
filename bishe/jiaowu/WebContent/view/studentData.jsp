								...
								<div class="row">
									...
									<div class="col-md-7">
												...
												<div class="container-fluid">
													<div class="row">
														<div class="col-md-12">
															...
															<div class="row">
																<div class="col-md-4">
																	<img src="${pageContext.request.contextPath}${sessionScope['_LOGIN_USER_'].userPic}" width="150" height="150"/>
																</div>
																<div class="col-md-8">
																	<h3>姓名：${sessionScope['_LOGIN_USER_'].userName }</h3>
																	<h3>专业：${sessionScope['_LOGIN_USER_'].userProfession }</h3>
																	<h3>班级：${sessionScope['_LOGIN_USER_'].userClass }</h3>
																	<h3>学历：${sessionScope['_LOGIN_USER_'].userRecord }</h3>
																	<h3>出生日期：${sessionScope['_LOGIN_USER_'].userBrithday }</h3>
																	<h3>入学时间：${sessionScope['_LOGIN_USER_'].userTime }</h3>
																	<h3>学生电话：${sessionScope['_LOGIN_USER_'].userPhone }</h3>
										...
										<div class="panel panel-info">
											<div class="panel-heading">
												<div class="modal-title text-center">
													<h3 class="panel-title">学生档案</h3>
												</div>
											</div>
											<div class="panel-body">
												<img src="${pageContext.request.contextPath}/images/19.jpg" width=200 height=200> <img
													src="${pageContext.request.contextPath}/images/19.jpg" width=200 height=200> <img
													src="${pageContext.request.contextPath}/images/19.jpg" width=200 height=200>
											</div>
